...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("	 本程序的版权归Richard.Hu所有，源代码仅限于学术研究使用，商用需要授权，在没有获得商用版权的情况下，应用于商用项目，将依法追究法律责任，感谢支持，详细说明请参照：");
        System.out.println("");
        ...
        System.out.println("	     1. 签合同，双方在合同上签字");
        System.out.println("		 2. 付款，支持支付宝，微信，银行卡");
        System.out.println("		 3. 开发票，增值税普票（个人找税务局代开的）");
        System.out.println("		 4. 加入 Hsl超级VIP群 即获得源代码和超级激活码，永久支持更新。");
        System.out.println("		 5. 注册官网的git账户");
        System.out.println("		 6. 专业培训额外付费，1000元人民币1小时，培训控件使用，控件开发。");
        System.out.println("		 7. 联系方式：Email:hsl200909@163.com   QQ:200962190   Weichat:13516702732");
        System.out.println("");
        System.out.println("	官网：http://www.hslcommunication.cn  如果不能访问，请访问：http://118.24.36.220");
        System.out.println("");
        System.out.println("");
        System.out.println("	The copyright of this program belongs to Richard.Hu. The source code is limited to academic research. Commercial licenses are required. ");
        ...
        System.out.println("	2. Payment, support Alipay, WeChat, bank card");
        System.out.println("	3. Invoice, general VAT ticket (issued on behalf of the individual, registered companies will be different later)");

    ...
    public void AddConnectSegment(JPanel panel){
        ...
        tcpConnectControl.ButtonConnect.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    tcpConnectControl.SetNetworkIpPort(siemensFetchWriteNet);
                    ...
                    StringBuilder stringBuilder = DemoUtils.CreatePlcDeviceCode( siemensFetchWriteNet, tcpConnectControl.TextBoxIp.getText(), tcpConnectControl.TextBoxPort.getText() );

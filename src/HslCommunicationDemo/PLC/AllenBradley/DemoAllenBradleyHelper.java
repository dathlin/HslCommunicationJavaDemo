...
public class DemoAllenBradleyHelper {
    ...
    public static DeviceAddressExample[] GetDF1AddressExamples( ) {
        return DemoUtils.GetAddressExamples(GetSLCAddressExamples(), new DeviceAddressExample("s=2;N9:0", "Integer 变量", true, true, "可以携带站号信息"),
                new DeviceAddressExample("s=2;dst=1;src=2;N9:0", "Integer 变量", true, true, "可以携带目标信息，原始站号信息"));
    }
        ...
        return new DeviceAddressExample[]
                {
                        ...
                        new DeviceAddressExample( "class=0x6b;attr=0x03;0xf68f", "符号实例特性", true, true, "也可以写成class=107;attr=3;63119, class是类ID，attr是特性，右侧是实例ID" ),

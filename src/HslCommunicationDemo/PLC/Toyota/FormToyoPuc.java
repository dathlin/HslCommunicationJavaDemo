package HslCommunicationDemo.PLC.Toyota;
...
public class FormToyoPuc extends HslJPanel
{

    public FormToyoPuc( JTabbedPane tabbedPane ){
        setLayout(null);
        add( new UserControlReadWriteHead("ToyoPuc", tabbedPane, this));
        ...
        addressExampleControl = new AddressExampleControl(ToyoPucHelper.GetToyotaAddress());

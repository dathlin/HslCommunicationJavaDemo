...
public class FormSiemensFW extends JDialog {

    public FormSiemensFW(){
        this.setTitle("Siemens FW Test Tool");
    ...
    public void AddNormal(JPanel panel){
        ...
        JLabel label3 = new JLabel("Fetch/Write");
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if(connect.IsSuccess){
                        ...
                        userControlReadWriteOp1.SetReadWriteNet(siemensFetchWriteNet, defaultAddress, 10);
                    }
                    else {
                        JOptionPane.showMessageDialog(
                                null,
    ...
    public void AddReadBulk(JPanel panel){
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                super.mouseClicked(e);
                OperateResultExOne<byte[]> read = siemensFetchWriteNet.Read(textField1.getText(),Short.parseShort(textField2.getText()));
                if(read.IsSuccess){
    ...
    public void AddCoreRead(JPanel panel){
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (button2.isEnabled() == false) return;
                super.mouseClicked(e);
                OperateResultExOne<byte[]> read = siemensFetchWriteNet.ReadFromCoreServer(SoftBasic.HexStringToBytes(textField1.getText()));
                if(read.IsSuccess){
                    textArea1.setText(SoftBasic.ByteToHexString(read.Content));
                }
                else {

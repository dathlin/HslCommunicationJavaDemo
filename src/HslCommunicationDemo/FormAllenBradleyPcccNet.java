...
public class FormAllenBradleyPcccNet extends JDialog
{

    public FormAllenBradleyPcccNet(){
        this.setTitle("AllenBradleyPcccNet Plc Test Tool");

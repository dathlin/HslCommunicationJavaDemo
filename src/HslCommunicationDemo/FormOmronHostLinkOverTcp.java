...
public class FormOmronHostLinkOverTcp extends JDialog {



    public FormOmronHostLinkOverTcp(){
        this.setTitle("Omrom HostLink Test Tool");
    ...
    public void AddNormal(JPanel panel){
        ...
        JLabel label3 = new JLabel("Fins HostLink OverTcp");
    ...
    public void AddReadBulk(JPanel panel){
        ...
        panelRead.setBorder(BorderFactory.createTitledBorder( "Read byte by Length - support random word read D100;A100;C100;H100"));
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (textField1.getText().contains(";")) {
                    OperateResultExOne<byte[]> read = omronFinsNet.Read(textField1.getText().split(";"));
                    if (read.IsSuccess) {

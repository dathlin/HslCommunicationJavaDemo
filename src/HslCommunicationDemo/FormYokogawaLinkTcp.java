...
public class FormYokogawaLinkTcp extends JDialog {

    public FormYokogawaLinkTcp(){
        this.setTitle("YokogawaLinkTcp plc Test Tool");
    ...
    public void AddNormal(JPanel panel){
        ...
        JLabel label3 = new JLabel("YokogawaLinkTcp");
    ...
    public void AddConnectSegment(JPanel panel){
        ...
        textField2.setText("12289");
        panelConnect.add(textField2);

        JLabel label4 = new JLabel("Cpu Number：");
        label4.setBounds(303, 17,88, 17);

...
public class FormPanasonicMewtocolOverTcp extends JDialog {

    public FormPanasonicMewtocolOverTcp(){
        this.setTitle("Panasonic plc Test Tool");
    ...
    public void AddNormal(JPanel panel){
        ...
        JLabel label3 = new JLabel("Mewtocol OverTcp");

...
public class FormAllenBradleySLCNet extends JDialog
{

    public FormAllenBradleySLCNet(){
    ...
    public void AddNormal(JPanel panel){
        ...
        JLabel label3 = new JLabel("SLC Net");
    ...
    public void AddConnectSegment(JPanel panel){
        ...
        button1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    allenBradleySLCNet.setIpAddress(textField1.getText());
                    allenBradleySLCNet.setPort(Integer.parseInt(textField2.getText()));
                    ...
                    if(connect.IsSuccess){
                        ...
                        userControlReadWriteOp1.SetReadWriteNet(allenBradleySLCNet, defaultAddress, 10);
                    }
                    else {
                        JOptionPane.showMessageDialog(
                                null,
    ...
    public void AddReadBulk(JPanel panel){
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (button2.isEnabled() == false) return;
                super.mouseClicked(e);
                OperateResultExOne<byte[]> read = allenBradleySLCNet.Read(textField1.getText(),Short.parseShort(textField2.getText()));
                if(read.IsSuccess){
    ...
    public void AddCoreRead(JPanel panel) {
        ...
        button2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (button2.isEnabled() == false) return;
                super.mouseClicked(e);
                OperateResultExOne<byte[]> read = allenBradleySLCNet.ReadFromCoreServer(SoftBasic.HexStringToBytes(textField1.getText()));
                if (read.IsSuccess) {
                    textArea1.setText(SoftBasic.ByteToHexString(read.Content));
                } else {
                    JOptionPane.showMessageDialog(

package cn.hslcommunication;

import HslCommunication.Authorization;
import cn.hslcommunication.HslCommunicationDemo.FormMain;

public class Main {
    public static void main(String[] args) {
        System.out.println("    欢迎 使用 HslCommunication");
        System.out.println("	CopyRight by Richard.Hu 2017-2023");
        ...
        System.out.println("	7. Contact: Email: hsl200909@163.com QQ: 200962190 Wechat: 13516702732");
        System.out.println("	");
        ...
        FormMain formLoad = new FormMain();
